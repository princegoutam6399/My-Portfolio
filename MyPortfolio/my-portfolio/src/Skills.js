function Myskills() {
    return (
        <div>
            <div className="container-xxl pt-5 " id="skill">
                            ...
                            <div className="row align-items-center">
                                <div className="col-md-6">
                                    <div className="skill mb-4">
                                        ...
                                        <div className="progress">
                                            <div className="progress-bar bg-success w-75" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                    <div className="skill mb-4">
                                        <div className="d-flex justify-content-between">
                                ...
                                <div className="col-md-6">
                                    <div className="skill mb-4">
                                        ...
                                        <div className="progress ">
                                            <div className="progress-bar bg-info w-75" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                    <div className="skill mb-4">
                                        <div className="d-flex justify-content-between">
                                ...
                                <div id="tab-1" className="tab-pane fade show p-0 active">
                                    <div className="row gy-5 gx-4">
                                        <div className="col-sm-6">
                                            <h5>UI Designer</h5>
                                            <hr className="text-primary my-2"></hr>
